...
// (docs/prd/mtdfa-product.md / docs/prd/mtnfa-product.md), plus
// "otf-mtdfa-product", which is Method 3.1's ONLY implementation --- its
// explicit cell OtfDfaProduct is unbuilt (docs/prd/otf-mtdfa-product.md)
// --- EIGHT flags over five methods.  "dfa-product", "mtdfa-product", "nfa-product",
// "mtnfa-product" and "otf-mtdfa-product" are wired
// (ltlf_ek::make_synthesis_method); the other three are not yet implemented.
// This list is the SECOND site a new flag must be added to ---
// make_synthesis_method (src/cli.cpp) alone is not enough, since ParseArgs
// rejects an unlisted flag before ever consulting the factory (the
...
const std::vector<std::string> kMethodFlags = {
    ...
    "mtnfa-product",     "otf-mtdfa-product",  "otf-dfa-product",
